<template>
  <!-- <div class="flex-wrapper">
    <div class="border-image-1px flex-item">1像素图片</div>
    <div class="normal-1px flex-item">直接设置为1px solid #999</div>
  </div> -->
  <normal1px><div class="border-image-1px flex-item">1像素图片</div></normal1px>
  <strong>缺点： 该方案需要制作图片， 圆角的时候还是会出现模糊。</strong>
  <el-divider>分割线...</el-divider>
  <normal1px>
    <div class="border-gradient-1px flex-item">使用linear-gradient</div>
  </normal1px>
  <strong>缺点： 不能实现圆角</strong>
</template>
